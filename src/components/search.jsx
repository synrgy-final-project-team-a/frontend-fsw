    ...
    <>
      <div className="d-flex align-items-center">
        <div className="d-flex w-100 col-md-6">
          ...
          <div className="form-search d-flex justify-content-between" onClick={routeToSearch}>
            ...
            <input type="text" className="w-100 border-0 mx-2" placeholder="Tulis daerah / alamat kosan yang akan kamu tuju  " onChange={handleChange} value={searchInput} />
            <button className="btn btn-primary m-1 rounded-full" onClick={(e) => handleButtonCariKos(e)}>
              Cari
            </button>
          </div>
        </div>
