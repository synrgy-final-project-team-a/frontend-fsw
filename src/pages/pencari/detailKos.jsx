						...
						<div id="detail-kos">
							...
							<div className="container my-3">
								<Breadcrumb>
									...
									<Breadcrumb.Item linkAs={Link} linkProps={{ to: "/pencarian", className: "text-decoration-none" }}>Pencarian</Breadcrumb.Item>
							...
							<Container id="foto-kos">
								<Row>
									...
									<Col xs={12} lg={4} className="d-none d-lg-flex flex-column justify-content-between">
										<img className="img-fluid rounded foto-kecil" src="/image/Kos2.png" alt="" />
										<img className="img-fluid rounded foto-kecil" src="/image/Kos3.png" alt="" />
									</Col>
								</Row>
							</Container>
							{/* End Gambar Kos */}
										...
										<Card className="shadow-sm mt-3">
											<Card.Body>
												<Card.Text className="mb-1">
													...
													<p className="my-0 fs-5">{kostOne.city}, {kostOne.province}</p>
